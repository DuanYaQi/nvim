...
-- 左右比例控制
map("n", "<C-Left>", ":vertical resize -2<CR>", opt)  -- mac !!!
map("n", "<C-Right>", ":vertical resize +2<CR>", opt) -- mac !!!
map("n", "s,", ":vertical resize -20<CR>", opt)
map("n", "s.", ":vertical resize +20<CR>", opt)
-- 上下比例
map("n", "sj", ":resize +10<CR>", opt)
map("n", "sk", ":resize -10<CR>", opt)
map("n", "<C-Down>", ":resize +2<CR>", opt) -- mac !!!
map("n", "<C-Up>", ":resize -2<CR>", opt)   -- mac !!!
-- 等比例
map("n", "s=", "<C-w>=", opt)
...
-- insert & normal & terminal 模式下，跳到行首行尾
map("i", "<C-a>", "<ESC>I", opt)
map("i", "<C-e>", "<ESC>A", opt)
map("n", "<C-a>", "<ESC>I", opt)
map("n", "<C-e>", "<ESC>A", opt)
...
pluginKeys.mapLSP = function(mapbuf)
  ...
  -- diagnostic
  mapbuf("n", "gp", "<cmd>lua vim.diagnostic.open_float()<CR>", opt) -- 以弹窗的方式显示改行提示
